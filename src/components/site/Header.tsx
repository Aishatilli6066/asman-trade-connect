  ...
  return (
    ...
    >
      <div className="container-x flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            <Link
              ...
              onClick={() => trackQuoteClick("header")}
                className="px-4 py-3 text-[10px] xl:text-[11px] uppercase tracking-[0.16em] font-semibold whitespace-nowrap bg-[var(--color-gold)] text-[var(--color-ink)] hover:bg-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            >
              Trade Inquiry
            </Link>
          </div>
        ...
        <button
          className="lg:hidden text-white p-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]"
          onClick={() => setOpen((o) => !o)}
      ...
      {open && (
        <div
          id="mobile-menu"
          className="lg:hidden fixed inset-x-0 top-20 bottom-0 z-40 bg-[var(--color-burgundy)] border-t border-white/10 overflow-y-auto overscroll-contain"
        >
